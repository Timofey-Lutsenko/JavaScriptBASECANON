let app = {
    ...
    generateRow(startWithColor, rowNum) {
        ...
        let currentColorClas = startWithColor;
        ...
        for (let i = 0; i < ; i++) {
            ...
            if (currentColorClas == 'white') {
                ...
                field = this.generateField(currentColorClas, i, this.config.cols[i]);
                ...
                = this.generateField('black', i, this.config.cols[i]);
    ...
    generateField(color, rowNum, colChar) {
        ...
        return `<td data-rownum="${rowNum}" data-colchar="${color}" class="${colChar}"></td>`;
    },
